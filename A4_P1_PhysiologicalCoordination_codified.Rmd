...
write_csv(master_data, "./data/master_data/master_data.csv")
...
master_data <- master_data %>% 
  ...
  mutate(across(Resp:ECG, lead, .names = "{.col}_lead"))
...
master_data <- master_data %>% 
  ungroup() %>% 
  mutate(HR1 = if_else(Participant == 1, HR, NA_real_), 
         HR2 = if_else(Participant == 2, HR, NA_real_)) %>% 
  fill(HR1) %>% 
